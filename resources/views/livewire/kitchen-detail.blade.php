...
<section class="py-8 bg-white md:py-16 dark:bg-gray-900 antialiased">
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
        ...
        <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
            <img class="w-full" src="{{ asset('storage/' . $kitchen->photos) }}" alt="" />
        </div>
        <div class="mt-6 sm:mt-8 lg:mt-0">
            ...
            >
                {{ Number::currency($kitchen->price, 'IDR') }}
            </p>
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16 mt-6">
                <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
                    <img class="w-full" src="{{ asset('storage/' . $kitchen->building->photos) }}" alt="" />
                </div>
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    <h1
                    class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white"
                    >
                    {{ $kitchen->building->name }}
                    </h1>
                    <div class="mt-4  sm:gap-4 ">
                    <p
                        class="text-sm text-gray-700 dark:text-white"
                    >
                    {{$kitchen->building->street}}
                    </p>
                    <p
                        class="text-sm text-gray-700 dark:text-white"
                    >
                    {{$kitchen->building->phone}}
                    </p>
                    <p
                        class="text-sm text-gray-700 dark:text-white"
                    >
                    {{$kitchen->building->city->name}}
                    </p>
                </div>
            </div>
