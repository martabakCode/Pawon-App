<div class="min-w-fit mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-5">
    ...
    <a href="#" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-800">Reserve</a>
</div>
